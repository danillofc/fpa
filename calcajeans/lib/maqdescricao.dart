...
class maqdescricao extends StatelessWidget {
  ...
  setasset() {
    if (maq == "pespontadeira") {
      ...
      descricao = "A interlok possui uma função parecida com a overlok, porém ela vem com duas linhas a mais, nos quais ela faz uma costura parecida com a da maquina reta. Esta costura facilita a dobra do tecido na hora de fazer o pesponto.";
    } else if (maq == "reta") {
